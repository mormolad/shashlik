import type { SpiceDefinition } from './types'
...
export const SPICE_DB: SpiceDefinition[] = [
  ...
  { name: 'paprika', baseAmount: 4, type: 'smoky', styles: ['classic', 'smoky', 'spicy'], compatibleWith: ['chicken', 'pork', 'beef', 'turkey'], priority: 4 },
  { name: 'smoked_paprika', baseAmount: 3, type: 'smoky', styles: ['smoky', 'spicy', 'premium'], compatibleWith: ['chicken', 'pork', 'beef', 'lamb'], priority: 4 },
  ...
  { name: 'rosemary', baseAmount: 2, type: 'herb', styles: ['premium', 'classic', 'smoky'], compatibleWith: ['pork', 'beef', 'lamb', 'turkey'], priority: 3 },
  { name: 'dill', baseAmount: 2.5, type: 'herb', styles: ['classic', 'herbal'], compatibleWith: ['chicken', 'pork', 'turkey'], priority: 2 },
  { name: 'chili', baseAmount: 2, type: 'hot', styles: ['spicy', 'eastern', 'smoky'], compatibleWith: ['chicken', 'pork', 'beef', 'lamb', 'turkey'], priority: 4 },
  ...
  { name: 'mustard_seed', baseAmount: 2.5, type: 'warm', styles: ['classic', 'premium', 'smoky'], compatibleWith: ['chicken', 'pork', 'beef'], priority: 2 },
